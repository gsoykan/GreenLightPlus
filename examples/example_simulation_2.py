...
season_length = 1  # Length of the growth cycle (days), can be fractional
season_interval = 1  # Time interval for each model run (days), can be fractional, e.g., 1/24/4 means 15 minutes
first_day = 1  # The first day of the growth cycle (day of the year)
...
if __name__ == '__main__':
    ...
    model = GreenLightModel(first_day=first_day,
                            isMature=True,
                            epw_path="../data/CHN_Beijing.Beijing.545110_CSWD.epw",
                            lampType="led",
